...
export default function Contact() {
  return (
    <section
      id="contact"
      className="w-full border-t border-border/50 pt-24 text-center max-w-3xl mx-auto"
    >
      <motion.div
      ...
      >
        ...
        <p className="text-lg text-muted-foreground leading-relaxed max-w-xl mx-auto">
          I&apos;m currently looking for new opportunities to build
          mathematically grounded and scalable AI systems. Whether you have a
